...
datos <-read_excel("Excel/Resultados_puntos_analisis.xlsx", range = "A1:X1057")
head(datos)
...
View(matriz_cambios_general_hum)
...
ggplot(df_matriz, aes(Var1, Var2, fill = Freq)) +
  geom_tile(color = "wdel Suelo en 1984", y = "Uso del Suelo en 2020", fill = "Frecuencia") +
  theme_minimahite") +  # Color blanco para separar las celdas
